...
import {
  formatCareerYearsExperience,
  formatCareerYearsShort,
  getCareerYears,
} from "../utils/careerYears";
...
const About = () => {
  ...
  const stats = [
    ...
    { icon: Coffee, label: "커피 컵", value: "1000+" },
    {
      icon: Briefcase,
      label: "경력 연차",
      value: formatCareerYearsShort(careerYears),
    },
  ];
            ...
            >
              <div>
                ...
                <p className="text-lg text-dark-600 dark:text-dark-300 mb-4">
                  {formatCareerYearsExperience(careerYears)} 개발 경험을 통해
                  프론트엔드 개발에 특화되어 있으면서도, 백엔드 개발까지 가능한
                  풀스택 개발자로 성장했습니다. TypeScript를 기반으로 Vue3와
                  React를 주력으로 사용하며, NestJS와 Java Spring으로 서버
                  개발도 진행합니다.
                </p>
                <p className="text-lg text-dark-600 dark:text-dark-300">
                  사용자 경험을 최우선으로 생각하며, 깔끔하고 유지보수가 용이한
                  코드 작성을 지향합니다. 새로운 기술 학습에 적극적이며, 팀
                  협업을 통해 더 나은 결과물을 만들어내는 것을 즐깁니다.
                </p>
              </div>
            </motion.div>
